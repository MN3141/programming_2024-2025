;Să se ruleze programul şi apoi să se modifice secţiunea de serviciu BIOS în
;sensul de a fi acceptate şi caracterele speciale. Acestea vor returna ca şi cod ASCII codul
;caracterului NULL, având ca reprezentare grafică un spaţiu. Să se determine astfel care taste
;nu produc nici o informaţie pentru a fi stocată în buffer-ul de tastatură.
;În ceea ce priveşte serviciul DOS 0AH, intrarea caracterelor poate fi redirectată
;spre un fişier. Pentru aceasta se va lansa programul pentru a citi caractere dintr-un fişier
;oarecare de tip text (de ex. CONFIG.SYS) folosind comanda:
;Nume_program.exe < Nume_fişier
;urmând ca serviciul DOS 0AH să preia automat prima linie din fişierul de intrare.
;***************************************************************************
.MODEL SMALL
.STACK
.DATA
